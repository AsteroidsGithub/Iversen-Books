...
const BooksTab: NextPage<{ tabName: string; books: Book[]; classes: Class[] }> = ({
  ...
  <div className="grid grid-cols-3 gap-2 px-2 pb-2 sm:px-8 md:grid-cols-4 lg:grid-cols-6 2xl:px-32">
    <h1 className="col-span-full pb-2 pt-4 text-2xl font-bold">Featured</h1>
    <div className="relative no-scrollbar col-span-full flex w-full snap-x snap-mandatory pb-2 gap-6 overflow-x-scroll ">
